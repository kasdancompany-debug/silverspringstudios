    ...
    <Section id="faq" tone="dark">
      <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <h2 className="mt-5 font-impact text-[clamp(2.25rem,6vw,3.75rem)] tracking-[0.04em] text-ivory">
            FAQs
          </h2>
          <p className="mt-6 max-w-sm text-[0.95rem] leading-[1.75] text-slate">
            Common questions about submission, packaging, rights, and reporting.
          </p>
        </div>
